...
This is an example of integrating [Kubecost](https://www.kubecost.com/) with [CID (Cloud Intelligence Dashboards)](https://wellarchitectedlabs.com/cost/200_labs/200_cloud_intelligence/).   
Here we demonstrate how AWS customers can break down EKS in-cluster cost and usage in a multi-cluster environment, and visualize this data alongside the other CID dashboards using data from a [self-hosted Kubecost pod](https://www.kubecost.com/products/self-hosted).
...
More information on the EKS-optimized bundle of Kubecost can be found in [this blog post](https://aws.amazon.com/blogs/containers/aws-and-kubecost-collaborate-to-deliver-cost-monitoring-for-eks-customers/) and [this section of the EKS user-guide](https://docs.aws.amazon.com/eks/latest/userguide/cost-monitoring.html).
