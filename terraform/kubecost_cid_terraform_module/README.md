...
| <a name="input_share_tenancy_costs"></a> share_tenancy_costs                                                                 | Dictates whether to include shared tenancy costs in the `sharedCost` field                                                    | `string` | `"Yes"`                                         | One of "Yes", "No", "Y" or "N" (case-insensitive)                                                             | no       |
