...
| <a name="input_clusters_labels"></a> clusters\_labels                             | A map of clusters and their K8s labels that you wish to include in the dataset                         | <pre>list(object({<br>    cluster_arn = string<br>    labels = optional(list(string))<br>  }))</pre> | `[]`                                        |    no    |
