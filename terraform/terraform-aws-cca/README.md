...
4. Save and publish the dataset by following the ["Save and Publish the Dashboard" section in the DEPLOYMENT.md file](../../DEPLOYMENT.md/.#save-and-publish-the-dashboard)
